...
4. **Parecer software de mercado**
   - Studio mostra o modelo de negócio, não o grafo técnico interno
   - interação direta no canvas vem antes de formulários crus
   - JSON/logs só aparecem em auditoria avançada
   - a UI principal deve parecer produto profissional, não console com abas

## Conteúdo do pacote

- `01_current_state_and_baseline.md`
- `02_ux_findings_and_problem_statement.md`
- `02b_market_grade_ux_doctrine.md`
